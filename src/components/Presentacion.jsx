        ...
        <div className="max-w-6xl mx-auto">
          ...
          `}>
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-green-500/10 border border-green-500/30 rounded-full">
              ...
              <span className="text-green-400 text-sm font-mono">about.dev</span>
            </div>
            ...
            <p className="text-green-300/80 text-lg md:text-xl max-w-2xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className={`
              backdrop-blur-xl bg-black/30 border border-green-500/30 rounded-3xl p-8
            ...
            `}>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-green-300">Mi Historia</h2>
                </div>

                <div className="space-y-4 text-green-200/90 leading-relaxed">
                  <p className="flex items-start gap-3">
                    <Flag className="w-5 h-5 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>
                      Soy un desarrollador de <strong className="text-green-300">19 años</strong> nacido y criado en Argentina, 
                  ...
                  <p className="flex items-start gap-3">
                    ...
                    <span>
                      Me especializo en <strong className="text-green-300">Frontend Development</strong>, creando interfaces 
                ...
                <div className="mt-8 p-4 bg-green-500/5 border border-green-500/20 rounded-xl">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-green-300 font-mono text-sm">Actualmente enfocado en:</span>
                  </div>
            ...
            <div className="space-y-8">
              ...
              {/* Personal stats */}
              <div className={`
                backdrop-blur-xl bg-black/30 border border-green-500/30 rounded-3xl p-6
                shadow-2xl shadow-green-500/10 relative overflow-hidden
                transition-all duration-1000 transform delay-300
                ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'}
              `}>
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-bl from-green-500/10 to-transparent" />
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {personalStats.map(({ icon: Icon, label, value }, index) => (
                      <div 
                        key={label}
                        className="p-4 bg-green-500/5 border border-green-500/20 rounded-xl hover:bg-green-500/10 transition-all duration-300 group"
                      >
                        <Icon className="w-6 h-6 text-green-400 mb-2 group-hover:scale-110 transition-transform duration-300" />
                        <p className="text-green-200 text-sm opacity-80">{value}</p>
              ...
              <div className={`
                ...
                ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-20 opacity-0'}
              `}>
                <div className="absolute inset-0 rounded-3xl bg-gradient-to-tr from-green-500/10 to-transparent" />
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1 h-2 bg-green-500/20 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-green-500 to-green-400 rounded-full animate-pulse" style={{width: '95%'}} />
                    </div>
                    <span className="text-green-300 font-mono text-sm">95%</span>
                  </div>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {frontendSkills.slice(0, 4).map((skill, index) => (
                      <span 
                        key={skill}
                        className="px-3 py-1 bg-green-500/10 border border-green-500/30 rounded-full text-xs text-green-300 font-mono"
                      >
                        {skill}
                      </span>
                    ))}
